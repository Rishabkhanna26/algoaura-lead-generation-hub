...
const indexedRoutes = [
  ...
  { path: "/website-development", priority: 0.8, changeFrequency: "weekly" },
  { path: "/crm-whatsapp-automation", priority: 0.8, changeFrequency: "weekly" },
  { path: "/solutions", priority: 0.8, changeFrequency: "weekly" },
  { path: "/process", priority: 0.7, changeFrequency: "monthly" },
  { path: "/portfolio", priority: 0.8, changeFrequency: "weekly" },
  { path: "/reports", priority: 0.7, changeFrequency: "weekly" },
  { path: "/client-results", priority: 0.7, changeFrequency: "weekly" },
